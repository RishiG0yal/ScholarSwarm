...
export default function FigureCard({ figure }) {
  ...
  return (
    <div className="bg-gray-900/60 border border-gray-800 rounded-2xl overflow-hidden">
      {/* Image */}
      <div
        className={`bg-gray-950 flex items-center justify-center cursor-pointer overflow-hidden transition-all duration-300 ${expanded ? "max-h-screen" : "max-h-48"}`}
      ...
      >
        {hasImage ? (
          <img
            ...
            className={`w-full object-contain transition-all duration-300 ${expanded ? "" : "object-top"}`}
            style={expanded ? {} : { maxHeight: "192px", objectPosition: "top" }}
            loading="lazy"
          />
        ) : (
          <div className="flex flex-col items-center gap-2 text-gray-700 py-8">
